...
public class ContinuityActivity extends AppCompatActivity {
    ...
    public static final String DESCRIPTION = "Animated line provoking a continuity feeling";
    /**
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_continuity, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_continuity, container, false);
